        ...
        <Result
          ...
          extra={
            <Space>
              ...
              <Button type="primary" icon={<RocketOutlined />} onClick={() => navigate('/home', { replace: true })}>返回首页</Button>
            </Space>
          }
        />
      </div>
        ...
        <Result
          ...
          extra={
            <Space>
              ...
              <Button icon={<RocketOutlined />} onClick={() => navigate('/home', { replace: true })}>返回首页</Button>
            </Space>
          }
        />
      </div>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '48px 24px' }}>
        ...
        {taskStatus === 'completed' && (
          <div style={{ textAlign: 'center', marginTop: 28 }}>
            <Text type="secondary">即将跳转到学习首页...</Text>
          </div>
        )}
      </div>
    </div>
