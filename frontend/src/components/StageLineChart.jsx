    ...
    return {
      tooltip: {
        ...
        formatter(params) {
          ...
          const topics = normalizeStringList(s.topics).join('、') || '--'
          const objectives = normalizeStringList(s.objectives).slice(0, 2).join('<br/>')
          const taskCount = normalizeTasks(s.tasks).length
          const sourceCount = Array.isArray(s.knowledge_sources) ? s.knowledge_sources.length : 0
          ...
          return `
            <div style="max-width:260px">
              ...
              <br/><span style="color:#888;font-size:11px">
                ...
                ${sourceCount ? `<br/>知识库依据：${sourceCount} 条` : ''}
              </span>
